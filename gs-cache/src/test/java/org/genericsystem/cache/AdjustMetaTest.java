...
public class AdjustMetaTest extends AbstractTest {
	...
	public void test002_AdjustMeta_MetaLevel_metaAttribut_OneComposite() {
		...
		assert engine.getCurrentCache().getBuilder().adjustMeta(engine, "Power", car).getValue().equals(metaAttribute.getValue());
		...
		assert metaAttribute.equals(engine.getCurrentCache().getBuilder().adjustMeta(engine, "Power", car));
	}
	...
	public void test003_AdjustMeta_MetaLevel_metaAttribut_TwoComposites() {
		...
		assert metaRelation.equals(engine.getCurrentCache().getBuilder().adjustMeta(engine, "CarColor", car, color));
	}
	...
	public void test004_AdjustMeta_MetaLevel_metaAttribute() {
		...
		Generic car = engine.addInstance("Car");
		Generic color = engine.addInstance("Color");
		assert engine.getMetaRelation().equals(engine.getCurrentCache().getBuilder().adjustMeta(engine, "CarColor", car, color));
		engine.addInstance("CarColor", car, color);
		assert engine.getMetaAttribute().equals(engine.getCurrentCache().getBuilder().adjustMeta(engine, "Radio", car));
	}

	public void test005_AdjustMeta_MetaLevel_metaRelation_ThreeComposites() {
		Engine engine = new Engine();
		Generic metaRelation = engine.getMetaRelation();
		assert metaRelation.equals(engine.getCurrentCache().getBuilder().adjustMeta(engine, engine.getValue(), engine, engine));
		assert metaRelation.equals(engine.setInstance(engine.getValue(), engine, engine));
		Generic car = engine.addInstance("Car");
		Generic color = engine.addInstance("Color");
		engine.addInstance("CarColor", car, color);
		Generic finition = engine.addInstance("Finition");
		assert metaRelation.equals(engine.getCurrentCache().getBuilder().adjustMeta(engine, "CarColorFinition", car, color, finition));
	}
	...
	public void test007_AdjustMeta_TypeLevel_Relation_TwoComposites_oneCompositeSpecializedByInheritance() {
		...
		assert vehicleColor.equals(engine.getCurrentCache().getBuilder().adjustMeta(vehicleColor, "CarRed", car, red)) : engine.getCurrentCache().getBuilder().adjustMeta(engine, "CarRed", car, red);
	}
	...
	public void test008_AdjustMeta_TypeLevel_Relation_TwoComposites_oneCompositeSpecializedByInstanciation() {
		...
		assert vehicleColor.equals(engine.getCurrentCache().getBuilder().adjustMeta(vehicleColor, "CarRed", myVehicle, red)) : engine.getCurrentCache().getBuilder().adjustMeta(engine, "CarRed", myVehicle, red);
	}
	...
	public void test010_AdjustMeta_TypeLevel_Relation_TwoComposites_TwoCompositeSpecializedByInstanciation() {
		...
		assert vehicleColor.equals(engine.getCurrentCache().getBuilder().adjustMeta(vehicleColor, "CarRed", myVehicle2, red)) : engine.getCurrentCache().getBuilder().adjustMeta(engine, "CarRed", myVehicle2, red);
	}
	...
	public void test012_AdjustMeta_TypeLevel_Relation_ThreeComposites() {
		...
		assert vehicleColor.equals(engine.getCurrentCache().getBuilder().adjustMeta(vehicleColor, "CarRed", myVehicle2, red, finition)) : engine.getCurrentCache().getBuilder().adjustMeta(engine, "CarRed", myVehicle2, red, finition);
	}
	...
	public void test013_AdjustMeta_TypeLevel_Relation_ThreeComposites() {
		...
		Generic finition = engine.addInstance("Finition");
		Generic myVehicle2 = vehicle2.addInstance("myVehicle2");
		assert vehicleColor2.equals(engine.getCurrentCache().getBuilder().adjustMeta(vehicleColor, "CarRed", myVehicle2, red, finition)) : engine.getCurrentCache().getBuilder().adjustMeta(vehicleColor, "CarRed", myVehicle2, red, finition);
	}
	...
	public void test014_AdjustMeta_TypeLevel_Relation_ThreeComposites() {
		...
		Generic finition = engine.addInstance("Finition");
		Generic myVehicle2 = vehicle2.addInstance("myVehicle2");
		assert vehicleColor2.equals(engine.getCurrentCache().getBuilder().adjustMeta(vehicleColor, "CarRed", myVehicle2, red, finition)) : engine.getCurrentCache().getBuilder().adjustMeta(engine, "CarRed", myVehicle2, red, finition);
	}
