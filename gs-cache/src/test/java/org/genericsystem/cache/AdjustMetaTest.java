...
public class AdjustMetaTest extends AbstractTest {
	...
	public void test002_AdjustMeta_MetaLevel_metaAttribut_OneComponent() {
		Engine engine = new Engine();
		Generic metaAttribute = engine.setInstance(engine.getValue(), engine);
	...
	public void test003_AdjustMeta_MetaLevel_metaAttribut_TwoComponents() {
		...
		assert metaAttribute.equals(engine.adjustMeta("CarColor", Arrays.asList(car, color)));
	}
	...
	public void test004_AdjustMeta_MetaLevel_metaAttribut() {
		...
		assert metaAttribute.equals(engine.adjustMeta("Radio", Arrays.asList(car)));
	}

	public void test005_AdjustMeta_MetaLevel_metaRelation_ThreeComponents() {
		Engine engine = new Engine();
		Generic metaAttribute = engine.getMetaAttribute();
		assert metaAttribute.equals(engine.adjustMeta(engine.getValue(), Arrays.asList(engine, engine)));
	...
	public void test012_AdjustMeta_TypeLevel_Relation_ThreeComponents() {
		...
		assert vehicleColor.equals(vehicleColor.adjustMeta("CarRed", Arrays.asList(car, red, finition))) : engine.adjustMeta("CarRed", Arrays.asList(car, red, finition));
	}
	...
	public void test013_AdjustMeta_TypeLevel_Relation_ThreeComponents() {
		...
		assert vehicleColor2.equals(vehicleColor.adjustMeta("CarRed", Arrays.asList(car, red, finition))) : engine.adjustMeta("CarRed", Arrays.asList(car, red, finition));
	}
	...
	public void test016_AdjustMeta_TypeLevel_Relation_ThreeComponents() {
		...
		Generic red = color2.addInstance("Red");
		assert vehicleColor3.equals(vehicleColor.adjustMeta("CarRed", Arrays.asList(car, red, finition))) : engine.adjustMeta("CarRed", Arrays.asList(car, red, finition));
	}
	...
	public void test017_AdjustMeta_TypeLevel_Relation_ThreeComponents() {
		...
		assert vehicleBus.equals(vehicleVehicle2.adjustMeta("carBus", Arrays.asList(car, bus)));
	}
	...
	public void test018_AdjustMeta_TypeLevel_Relation() {
		...
		assert vehicleVehicle2IntensityUnitWatt.equals(vehicleVehicle2.adjustMeta("carBus", Arrays.asList(car, bus, v110, intensityUnit, kWatt)));
	}
