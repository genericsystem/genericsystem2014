...
public class AdjustMetaTest extends AbstractTest {
	...
	public void test002_AdjustMeta_MetaLevel_metaAttribut_OneComposite() {
		...
		assert engine.adjustMeta("Power", Collections.singletonList(car)).getValue().equals(metaAttribute.getValue());
		...
		assert metaAttribute.equals(engine.adjustMeta("Power", Collections.singletonList(car)));
	}
	...
	public void test003_AdjustMeta_MetaLevel_metaAttribut_TwoComposites() {
		...
		assert metaRelation.equals(engine.adjustMeta("CarColor", Arrays.asList(car, color)));
	}
	...
	public void test004_AdjustMeta_MetaLevel_metaAttribute() {
		...
		Generic car = engine.addInstance("Car");
		Generic color = engine.addInstance("Color");
		assert engine.getMetaRelation().equals(engine.adjustMeta("CarColor", Arrays.asList(car, color)));
		engine.addInstance("CarColor", car, color);
		assert engine.getMetaAttribute().equals(engine.adjustMeta("Radio", Arrays.asList(car)));
	}

	public void test005_AdjustMeta_MetaLevel_metaRelation_ThreeComposites() {
		Engine engine = new Engine();
		Generic metaRelation = engine.getMetaRelation();
		assert metaRelation.equals(engine.adjustMeta(engine.getValue(), Arrays.asList(engine, engine)));
		assert metaRelation.equals(engine.setInstance(engine.getValue(), engine, engine));
		Generic car = engine.addInstance("Car");
		Generic color = engine.addInstance("Color");
		engine.addInstance("CarColor", car, color);
		Generic finition = engine.addInstance("Finition");
		assert metaRelation.equals(engine.adjustMeta("CarColorFinition", Arrays.asList(car, color, finition)));
	}
	...
	public void test007_AdjustMeta_TypeLevel_Relation_TwoComposites_oneCompositeSpecializedByInheritance() {
		...
		assert vehicleColor.equals(vehicleColor.adjustMeta("CarRed", Arrays.asList(car, red))) : engine.adjustMeta("CarRed", Arrays.asList(car, red));
	}
	...
	public void test008_AdjustMeta_TypeLevel_Relation_TwoComposites_oneCompositeSpecializedByInstanciation() {
		...
		assert vehicleColor.equals(vehicleColor.adjustMeta("CarRed", Arrays.asList(myVehicle, red))) : engine.adjustMeta("CarRed", Arrays.asList(myVehicle, red));
	}
	...
	public void test010_AdjustMeta_TypeLevel_Relation_TwoComposites_TwoCompositeSpecializedByInstanciation() {
		...
		assert vehicleColor.equals(vehicleColor.adjustMeta("CarRed", Arrays.asList(myVehicle2, red))) : engine.adjustMeta("CarRed", Arrays.asList(myVehicle2, red));
	}
	...
	public void test012_AdjustMeta_TypeLevel_Relation_ThreeComposites() {
		...
		assert vehicleColor.equals(vehicleColor.adjustMeta("CarRed", Arrays.asList(myVehicle2, red, finition))) : engine.adjustMeta("CarRed", Arrays.asList(myVehicle2, red, finition));
	}
	...
	public void test013_AdjustMeta_TypeLevel_Relation_ThreeComposites() {
		...
		Generic finition = engine.addInstance("Finition");
		Generic myVehicle2 = vehicle2.addInstance("myVehicle2");
		assert vehicleColor2.equals(vehicleColor.adjustMeta("CarRed", Arrays.asList(myVehicle2, red, finition))) : vehicleColor.adjustMeta("CarRed", Arrays.asList(myVehicle2, red, finition));
	}
	...
	public void test014_AdjustMeta_TypeLevel_Relation_ThreeComposites() {
		...
		Generic finition = engine.addInstance("Finition");
		Generic myVehicle2 = vehicle2.addInstance("myVehicle2");
		assert vehicleColor2.equals(vehicleColor.adjustMeta("CarRed", Arrays.asList(myVehicle2, red, finition))) : engine.adjustMeta("CarRed", Arrays.asList(myVehicle2, red, finition));
	}
	...
	public void test020_AdjustMeta_TypeLevel_Attribute() {
		...
		assert carPower.equals(power.adjustMeta(235, Arrays.asList(car)));
	}
}
