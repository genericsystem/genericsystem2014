...
import org.genericsystem.mutability.annotations.Components;
import org.genericsystem.mutability.annotations.Dependencies;
import org.genericsystem.mutability.annotations.Meta;
import org.genericsystem.mutability.annotations.constraints.InstanceValueClassConstraint;
import org.genericsystem.mutability.annotations.constraints.PropertyConstraint;
import org.genericsystem.mutability.annotations.constraints.RequiredConstraint;
import org.genericsystem.mutability.annotations.constraints.SingularConstraint;
import org.genericsystem.mutability.annotations.constraints.UniqueValueConstraint;
import org.genericsystem.mutability.annotations.value.BooleanValue;
import org.genericsystem.mutability.annotations.value.IntValue;
import org.genericsystem.mutability.annotations.value.StringValue;
...
public class SystemCache<T extends AbstractGeneric<T, ?>> extends HashMap<Class<?>, T> {
	...
	private List<T> setOverrides(Class<?> clazz) {
		...
		org.genericsystem.mutability.annotations.Supers supersAnnotation = clazz.getAnnotation(org.genericsystem.mutability.annotations.Supers.class);
